 ...
 *
 */
public class FlagBookmarkAction extends BookmarkDefaultAction {
    /**
     *
     */
    public FlagBookmarkAction() {
        super();
    ...
    protected ActionForward doExecute(ActionMapping mapping, ActionForm form,
        ...
        try {
            String idint = request.getParameter("idint");

            Bookmark bookmarkInstance = getBookmarkInstance(request);

            bookmarkInstance.flagBookmark(idint);
        } catch (Exception ex) {
