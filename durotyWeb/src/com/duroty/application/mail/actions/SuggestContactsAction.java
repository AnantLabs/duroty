 ...
 *
 */
public class SuggestContactsAction extends MailDefaultAction {
    /**
     * DOCUMENT ME!
     */
    private static final String SUGGEST_CONTACTS = "suggestContacts";

    /**
     *
     */
    public SuggestContactsAction() {
        super();
    }
    ...
    protected ActionForward doExecute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            request.setAttribute(SUGGEST_CONTACTS,
                preferencesInstance.suggestContacts(token));
        } catch (Exception ex) {
