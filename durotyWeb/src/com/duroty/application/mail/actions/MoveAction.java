 ...
 *
 */
public class MoveAction extends MailDefaultAction {
    /**
     *
     */
    public MoveAction() {
    ...
    protected ActionForward doExecute(ActionMapping mapping, ActionForm form,
        ...
        try {        	
        	...
        	if (pos > -1) {
        		...
        		mailInstance.moveMessages(mids, folder);
        	} else {
        		pos = folder.indexOf("label:");
        		if (pos > -1) {
        			folder = folder.substring(folder.indexOf("*") + 1, folder.length());
        			mailInstance.applyLabel(new Integer(folder), mids);
        		} else {
        			//borrar desde search
        		}
        	}        	
