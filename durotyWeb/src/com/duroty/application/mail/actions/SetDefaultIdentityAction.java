 ...
 * @version $Revision$
 */
public class SetDefaultIdentityAction extends MailDefaultAction {
    /**
     * Creates a new SetDefaultIdentityAction object.
     */
    public SetDefaultIdentityAction() {
        super();
    ...
    protected ActionForward doExecute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            try {
                idint = Integer.valueOf(request.getParameter("idint"));
            } catch (Exception e) {
                idint = 0;
            }
            ...
            preferences.setIdentityDefault(idint);
        } catch (Exception ex) {
