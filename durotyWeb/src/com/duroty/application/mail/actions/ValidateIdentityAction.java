 ...
 * @version $Revision$
 */
public class ValidateIdentityAction extends MailDefaultAction {
    /**
     * Creates a new ValidateIdentityAction object.
     */
    public ValidateIdentityAction() {
        super();
    }
    ...
    protected ActionForward doExecute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            preferencesInstance.validateIdentity(user, code);
        } catch (Exception ex) {
