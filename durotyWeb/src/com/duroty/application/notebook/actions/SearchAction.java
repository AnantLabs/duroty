    ...
    */
    ...
    protected ActionForward doExecute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            SearchObj searchObj = bookmarkInstance.search(token, page, messagesByPage.intValue(), order.intValue(), extra, true);

            if ((searchObj == null) && (didYouMean != null)) {
                searchObj = bookmarkInstance.search(didYouMean, page, messagesByPage.intValue(), order.intValue(), extra, true);
