...
<tiles:insert template="/template/mail_template.jsp">
    ...
    <tiles:put name="advancedSearch" content="/mail/advancedSearch.jsp" />
    <tiles:put name="createFilter" content="/mail/createFilter.jsp" />

    <tiles:put name="left" content="/mail/left.jsp" />
    
    <tiles:put name="contents" content="/mail/mailContents.jsp" />
