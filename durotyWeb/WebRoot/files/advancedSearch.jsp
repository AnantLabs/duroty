...
<div id="divAdvancedSearch" class="hide" style="margin-left: 10px; margin-right: 10px; padding-top: 10px; padding-bottom: 10px;">
	<FORM action="" method="get" name="formAdvancedSearch" onsubmit="Files.getFiles(-1, -1, 0, 0, 'DESC', -2);return false;" style="margin: 0px; padding: 0px;">
					...
					<table width="100%" border="0" cellspacing="3" cellpadding="4" style="background-color: #fbf9c1;">
						<tr>							
							...
							<td width="50%" nowrap="nowrap" style="font-size: 10px;">
								<input type="text" name="hasWords" size="20" style="width: 50%;" />
							</td>
						</tr>
						<tr>							
							<td style="text-align: right;" nowrap="nowrap">
