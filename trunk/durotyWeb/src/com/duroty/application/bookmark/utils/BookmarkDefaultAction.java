...
import com.duroty.application.bookmark.interfaces.BookmarkHome;
import com.duroty.application.bookmark.interfaces.BookmarkUtil;
 ...
 *
 */
public abstract class BookmarkDefaultAction extends DefaultAction {
    ...
    protected String getPagination(HttpServletRequest request, String action,
        ...
        Pagination pagination = new Pagination("Bookmark", pag, hits,
