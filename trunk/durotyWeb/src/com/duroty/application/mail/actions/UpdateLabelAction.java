 ...
 * @version $Revision$
 */
public class UpdateLabelAction extends MailDefaultAction {
    /**
     * Creates a new FormFilterAction object.
     */
    public UpdateLabelAction() {
        super();
    ...
    protected ActionForward doExecute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            label.setIdint(((Integer) _form.get("idint")).intValue());
            label.setName((String) _form.get("name"));
            
            preferencesInstance.updateLabel(label);
        } catch (Exception ex) {
