...
<tiles:insert template="/template/bookmark_template.jsp">
    ...
    <tiles:put name="left" content="/bookmark/left.jsp" />
    
    <tiles:put name="contents" content="/bookmark/bookmarkContents.jsp" />
