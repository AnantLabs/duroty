...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<c:out value="${sessionScope['org.apache.struts.action.LOCALE']}" />" lang="<c:out value="${sessionScope['org.apache.struts.action.LOCALE']}" />">
	...
	<head>
		...
		<script type="text/javascript" src="<%=basePath%>bookmark/javascript/bookmark.js"></script>

		<link href="<%=basePath%>style/bookmark_style.css" rel="stylesheet" type="text/css" />
	</head>
	<body>
		<script language="JavaScript">
			if (window == top) {
				alert('It is not allowed to see the frame individually');
				top.location.href = "<%=basePath%>bookmark/index.jsp";
			}
		</script>		
				...
				<tr>
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td class="headLeft">
									<form action="" method="post" onsubmit="javascript:Bookmark.displayLocation('search:0*0!0', null);return false;" enctype="multipart/form-data">
										<table border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td nowrap="nowrap" align="left" style="padding-left: 3px;">
													<input type="button" name="btnSearch" class="BUTTON" value="<fmt:message key="general.search" />" onclick="javascript:Bookmark.displayLocation('search:0*0!0', null);" />
												</td>
		...
		<iframe src="<%=basePath%>bookmark/session.jsp" id="session" name="session" width="0" frameborder="0"></iframe>
	</body>
</html>
