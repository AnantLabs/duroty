...
<tiles:insert template="/template/notebook_template.jsp">
    ...
    <tiles:put name="left" content="/notebook/left.jsp" />
    
    <tiles:put name="contents" content="/notebook/notebookContents.jsp" />

    <tiles:put name="foot" content="/notebook/foot.jsp" />
