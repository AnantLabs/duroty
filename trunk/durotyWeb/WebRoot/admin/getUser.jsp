...
<html:form action="admin/updateUser.drt" method="post" target="util" style="padding: 0px; margin: 0px;" enctype="multipart/form-data">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td width="100%">
				<html:text property="username" size="50" maxlength="200" disabled="true"/>
			</td>
		</tr>
		<tr>
