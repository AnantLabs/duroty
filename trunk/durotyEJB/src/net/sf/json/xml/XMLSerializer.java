...
public class XMLSerializer {
     ...
     * @return DOCUMENT ME!
     */
    private static JSONArray processArrayElement(Element element,
        String defaultType) {
     ...
     * @return DOCUMENT ME!
     */
    private static JSONObject processObjectElement(Element element,
        String defaultType) {
        Attribute nullAttribute = element.getAttribute("null");

        if ((nullAttribute != null) &&
                (nullAttribute.getValue().compareToIgnoreCase("true") == 0)) {
     ...
     * @param defaultType DOCUMENT ME!
     */
    private static void set(JSONArray jsonArray, Element element,
        String defaultType) {
     ...
     * @param defaultType DOCUMENT ME!
     */
    private static void set(JSONObject jsonObject, Element element,
        String defaultType) {
        String clazz = getClass(element);
        String type = getType(element);
        type = (type == null) ? defaultType : type;
        ...
        if (clazz != null) {
            if (clazz.compareToIgnoreCase(JSONTypes.ARRAY) == 0) {
                jsonObject.put(element.getLocalName(),
    ...
    private static class XomSerializer extends Serializer {
        /**
         * Creates a new XomSerializer object.
         *
