...
public class MailUtil {
    ...
    private static com.duroty.application.mail.interfaces.MailHome cachedRemoteHome =
        null;
     ...
     */
    public static com.duroty.application.mail.interfaces.MailHome getHome()
        throws javax.naming.NamingException {
        if (cachedRemoteHome == null) {
            cachedRemoteHome = (com.duroty.application.mail.interfaces.MailHome) lookupHome(null,
                    com.duroty.application.mail.interfaces.MailHome.COMP_NAME,
                    com.duroty.application.mail.interfaces.MailHome.class);
        }
    ...
    public static com.duroty.application.mail.interfaces.MailHome getHome(
        ...
        return (com.duroty.application.mail.interfaces.MailHome) lookupHome(environment,
            com.duroty.application.mail.interfaces.MailHome.COMP_NAME,
            com.duroty.application.mail.interfaces.MailHome.class);
    }
    ...
    public static final String generateGUID(Object o) {
        ...
        if (hexServerIP == null) {
            ...
            try {
                ...
                System.err.println(
                    "MailUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
