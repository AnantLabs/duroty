...
public class PreferencesUtil {
    ...
    private static com.duroty.application.mail.interfaces.PreferencesHome cachedRemoteHome =
        null;
     ...
     */
    public static com.duroty.application.mail.interfaces.PreferencesHome getHome()
        throws javax.naming.NamingException {
        if (cachedRemoteHome == null) {
            cachedRemoteHome = (com.duroty.application.mail.interfaces.PreferencesHome) lookupHome(null,
                    com.duroty.application.mail.interfaces.PreferencesHome.COMP_NAME,
                    com.duroty.application.mail.interfaces.PreferencesHome.class);
        }
    ...
    public static com.duroty.application.mail.interfaces.PreferencesHome getHome(
        ...
        return (com.duroty.application.mail.interfaces.PreferencesHome) lookupHome(environment,
            com.duroty.application.mail.interfaces.PreferencesHome.COMP_NAME,
            com.duroty.application.mail.interfaces.PreferencesHome.class);
    }
    ...
    public static final String generateGUID(Object o) {
        ...
        if (hexServerIP == null) {
            ...
            try {
                ...
                System.err.println(
                    "PreferencesUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
