...
public class SendUtil {
    ...
    private static com.duroty.application.mail.interfaces.SendHome cachedRemoteHome =
        null;
     ...
     */
    public static com.duroty.application.mail.interfaces.SendHome getHome()
        throws javax.naming.NamingException {
        if (cachedRemoteHome == null) {
            cachedRemoteHome = (com.duroty.application.mail.interfaces.SendHome) lookupHome(null,
                    com.duroty.application.mail.interfaces.SendHome.COMP_NAME,
                    com.duroty.application.mail.interfaces.SendHome.class);
        }
    ...
    public static com.duroty.application.mail.interfaces.SendHome getHome(
        ...
        return (com.duroty.application.mail.interfaces.SendHome) lookupHome(environment,
            com.duroty.application.mail.interfaces.SendHome.COMP_NAME,
            com.duroty.application.mail.interfaces.SendHome.class);
    }
    ...
    public static final String generateGUID(Object o) {
        ...
        if (hexServerIP == null) {
            ...
            try {
                ...
                System.err.println(
                    "SendUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
