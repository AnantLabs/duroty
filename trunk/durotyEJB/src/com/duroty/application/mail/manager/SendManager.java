...
public class SendManager {
     ...
     */
    public SendManager(HashMap properties)
        throws ClassNotFoundException, InstantiationException, 
            IllegalAccessException {
        super();

        /*String luceneAnalyzer = (String) properties.get(Constants.MAIL_LUCENE_ANALYZER);
     ...
     */
    public void send(org.hibernate.Session hsession, Session session,
        String repositoryName, int ideIdint, String to, String cc, String bcc,
        String subject, String body, Vector attachments, boolean isHtml,
        String charset, InternetHeaders headers, String priority)
        ...
        try {
            ...
            if (headers != null) {
                ...
                email.addHeader(RFC2822Headers.IN_REPLY_TO,
                    "<" + mid + ".JavaMail.duroty@duroty" + ">");
                email.addHeader(RFC2822Headers.REFERENCES,
                    "<" + mid + ".JavaMail.duroty@duroty" + ">");
            }
     ...
     * @throws MailException DOCUMENT ME!
     */
    public void saveDraft(org.hibernate.Session hsession, Session session,
        String repositoryName, int ideIdint, String to, String cc, String bcc,
        String subject, String body, Vector attachments, boolean isHtml,
        String charset, InternetHeaders headers, String priority)
        throws MailException {
     ...
     */
    protected Identity getIdentity(org.hibernate.Session hsession,
        int ideIdint, Users users) throws Exception {
        try {
     ...
     */
    public InternetHeaders getHeaders(org.hibernate.Session hsession,
        String repositoryName, String mid) {
     ...
     * @throws MailException DOCUMENT ME!
     */
    public void sendIdentity(Session session, String repositoryName,
