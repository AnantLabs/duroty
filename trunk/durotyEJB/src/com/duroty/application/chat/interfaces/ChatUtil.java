...
public class ChatUtil {
    ...
    private static com.duroty.application.chat.interfaces.ChatHome cachedRemoteHome =
        null;
     ...
     */
    public static com.duroty.application.chat.interfaces.ChatHome getHome()
        throws javax.naming.NamingException {
        if (cachedRemoteHome == null) {
            cachedRemoteHome = (com.duroty.application.chat.interfaces.ChatHome) lookupHome(null,
                    com.duroty.application.chat.interfaces.ChatHome.COMP_NAME,
                    com.duroty.application.chat.interfaces.ChatHome.class);
        }
    ...
    public static com.duroty.application.chat.interfaces.ChatHome getHome(
        ...
        return (com.duroty.application.chat.interfaces.ChatHome) lookupHome(environment,
            com.duroty.application.chat.interfaces.ChatHome.COMP_NAME,
            com.duroty.application.chat.interfaces.ChatHome.class);
    }
    ...
    public static final String generateGUID(Object o) {
        ...
        if (hexServerIP == null) {
            ...
            try {
                ...
                System.err.println(
                    "ChatUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
