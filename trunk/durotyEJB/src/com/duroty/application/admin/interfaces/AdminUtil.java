...
public class AdminUtil {
    ...
    private static com.duroty.application.admin.interfaces.AdminHome cachedRemoteHome =
        null;
     ...
     */
    public static com.duroty.application.admin.interfaces.AdminHome getHome()
        throws javax.naming.NamingException {
        if (cachedRemoteHome == null) {
            cachedRemoteHome = (com.duroty.application.admin.interfaces.AdminHome) lookupHome(null,
                    com.duroty.application.admin.interfaces.AdminHome.COMP_NAME,
                    com.duroty.application.admin.interfaces.AdminHome.class);
        }
    ...
    public static com.duroty.application.admin.interfaces.AdminHome getHome(
        ...
        return (com.duroty.application.admin.interfaces.AdminHome) lookupHome(environment,
            com.duroty.application.admin.interfaces.AdminHome.COMP_NAME,
            com.duroty.application.admin.interfaces.AdminHome.class);
    }
    ...
    public static final String generateGUID(Object o) {
        ...
        if (hexServerIP == null) {
            ...
            try {
                ...
                System.err.println(
                    "AdminUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
