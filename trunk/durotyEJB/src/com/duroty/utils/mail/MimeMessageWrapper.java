...
public class MimeMessageWrapper extends MimeMessage implements Disposable {
    ...
    private synchronized void loadHeaders() throws MessagingException {
        ...
        try {
            ...
            throw new MessagingException(
                "Unable to parse headers from stream: " + ioe.getMessage(), ioe);
        }
    }
    ...
    public void writeTo(OutputStream headerOs, OutputStream bodyOs,
        ...
        if ((message == null) || !isModified()) {
            ...
            try {
                ...
                for (Enumeration e = headers.getNonMatchingHeaderLines(
                            ignoreList); e.hasMoreElements();) {
     ...
     */
    public static void writeTo(MimeMessage message, OutputStream headerOs,
        OutputStream bodyOs, String[] ignoreList)
        throws IOException, MessagingException {
    ...
    public int getLineCount() throws MessagingException {
        ...
        try {
            LineNumberReader counter = new LineNumberReader(new InputStreamReader(
                        in, getEncoding()));
    ...
    public void setSubject(String subject, String charset)
        ...
        // is this correct?
        try {
            headers.setHeader(RFC2822Headers.SUBJECT,
                new String(subject.getBytes(charset)));
