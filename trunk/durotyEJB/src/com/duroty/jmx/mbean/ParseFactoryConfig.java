 ...
 * @version 1.0
*/
public class ParseFactoryConfig extends ServiceMBeanSupport implements ParseFactoryConfigMBean {
    /**
     * DOCUMENT ME!
     */
    ...
    protected void startService() throws Exception {
        ...
        bind((String) ApplicationConstants.options.get(Constants.PARSE_FACTORY_CONFIG),
            properties);
    }
    ...
    protected void stopService() throws Exception {
        ...
        unbind((String) ApplicationConstants.options.get(Constants.PARSE_FACTORY_CONFIG));
    }
    ...
    private void unbind(String name) throws NamingException {
        if (name != null) {
            ...
            log.info("ParseFactoryConfig service '" + name + "' removed from JNDI");
        }
    }
    ...
    private void bind(String name, Object object) throws NamingException {
        ...
        log.info("ParseFactoryConfig Service bound to " + name);
    }
