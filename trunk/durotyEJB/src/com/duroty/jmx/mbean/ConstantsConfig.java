...
public class ConstantsConfig extends ServiceMBeanSupport implements ConstantsConfigMBean {
    ...
    /* (non-Javadoc)
     * @see com.duroty.jmx.mbean.ConstantsConfigMBean#getConfiguration()
     */
    ...
    /* (non-Javadoc)
     * @see com.duroty.jmx.mbean.ConstantsConfigMBean#setConfiguration(org.w3c.dom.Element)
     */
    ...
    private void bind(String name, Object object) throws NamingException {
        ...
        log.info("ConstantsConfig Service bound to " + name);
    }
