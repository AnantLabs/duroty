/* CVS ID: $Id: Helper.java,v 1.1 2006/03/08 09:07:01 durot Exp $ */
...
public class Helper {
    ...
    private static final int[] con_salt = {
            ...
            0x09, 0x0A, 0x0B, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C,
            0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
            0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22,
            0x23, 0x24, 0x25, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27,
     ...
     * @param Eswap0 DOCUMENT ME!
     * @param Eswap1 DOCUMENT ME!
     *
     * @return DOCUMENT ME!
     */
    ...
    public static String decryptTEA(String src) {
        ...
        for (int i = 0; (i < inb.length) && tok.hasMoreTokens(); i++) {
            ...
            try {
                ...
                System.err.println("Could not convert string '" + s +
                    "' to byte.");
            }
        }
    ...
    public static int getQuoteLevel(String token) {
        ...
        for (int i = 0;
                (i < token.length()) &&
                (token.substring(i).startsWith(">") ||
                token.substring(i).startsWith(" ")); i++) {
     ...
     * @param line DOCUMENT ME!
     * @param linesize DOCUMENT ME!
     * @param quotelevel DOCUMENT ME!
     *
     * @return DOCUMENT ME!
     */
    public static Enumeration breakLine(String line, int linesize,
        int quotelevel) {
        if (line.length() <= linesize) {
            ...
            final Enumeration enum1 = breakLine(rest, linesize, quotelevel);

            return new Enumeration() {
                    int count = 0;

                    public boolean hasMoreElements() {
                        return (count < 1) || enum1.hasMoreElements();
                    }
