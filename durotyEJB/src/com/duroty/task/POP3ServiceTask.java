 ...
 *
 */
public class POP3ServiceTask implements Schedulable, Servible,
    ...
    */
    ...
    public void perform(Date arg0, long arg1) {
        if (isInit()) {
            DLog.log(DLog.DEBUG, this.getClass(),
                "POP3ServiceTask is running and wait.");
                        ...
                        if ((info != null) && (info.length > 0)) {
                            for (int i = 0; i < info.length; i++) {
                                ...
                                boolean existMessage = existMessageName(hfactory.openSession(),
                                        user, info[i].identifier);

                                String key = info[i].identifier + "--" +
                                    repositoryName;
                                ...
                                if (existMessage) {
                                    ...
                                    if (!poolContains(key)) {
                                        ...
                                        MimeMessage mime = buildMimeMessage(info[i].identifier,
                                                reader, user);
     ...
     */
    private MimeMessage buildMimeMessage(String mid, Reader reader, Users user)
