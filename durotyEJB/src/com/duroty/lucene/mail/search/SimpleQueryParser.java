...
public class SimpleQueryParser extends QueryParser
    ...
    */
    ...
    public static final String[] messageFields = new String[] {
            Field_from, Field_to, Field_cc, Field_subject, Field_body,
            Field_attachments, Field_filetype, Field_has_attachments
        };
    ...
    public static final int[] messageFlags = new int[] {
            ...
            NORMAL_FIELD, NORMAL_FIELD, NORMAL_FIELD
        };
    ...
    public static Query parse(String queryString, Analyzer analyzer)
        ...
        if (queryString.indexOf(':') == -1) {
            ...
            if (queryString.indexOf("hasattachments:true") > -1) {
                queryString = queryString.replaceAll("hasattachments:true", "")
                                         .trim();
                ...
                if ((queryString != null) && (queryString.length() > 0)) {
                    ...
                    parser = new QueryParser(Field_has_attachments,
                            new KeywordAnalyzer());
                    parser.setDefaultOperator(Operator.AND);
