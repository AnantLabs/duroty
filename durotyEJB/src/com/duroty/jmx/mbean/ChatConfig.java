 ...
 * @version 1.0
*/
public class ChatConfig extends ServiceMBeanSupport implements ChatConfigMBean {
    /**
     * DOCUMENT ME!
     */
    ...
    /* (non-Javadoc)
     * @see com.duroty.jmx.mbean.ChatConfigMBean#getConfiguration()
     */
    ...
    /* (non-Javadoc)
     * @see com.duroty.jmx.mbean.ChatConfigMBean#setConfiguration(org.w3c.dom.Element)
     */
    ...
    protected void startService() throws Exception {
        ...
        bind((String) ApplicationConstants.options.get(Constants.CHAT_CONFIG),
            properties);
    }
    ...
    protected void stopService() throws Exception {
        ...
        unbind((String) ApplicationConstants.options.get(Constants.CHAT_CONFIG));
    }
    ...
    private void unbind(String name) throws NamingException {
        if (name != null) {
            ...
            log.info("ChatConfig service '" + name + "' removed from JNDI");
        }
    }
    ...
    private void bind(String name, Object object) throws NamingException {
        ...
        log.info("ChatConfig Service bound to " + name);
    }
