 ...
 * @version 1.0
*/
public class BookmarkConfig extends ServiceMBeanSupport
    implements BookmarkConfigMBean {
    /**
     * DOCUMENT ME!
     */
    ...
    /* (non-Javadoc)
     * @see com.duroty.jmx.mbean.BookmarkConfigMBean#getConfiguration()
     */
    ...
    /* (non-Javadoc)
     * @see com.duroty.jmx.mbean.BookmarkConfigMBean#setConfiguration(org.w3c.dom.Element)
     */
    ...
    protected void startService() throws Exception {
        ...
        bind((String) ApplicationConstants.options.get(
                Constants.BOOKMARK_CONFIG), properties);
    }
    ...
    private void unbind(String name) throws NamingException {
        if (name != null) {
            ...
            log.info("BookmarkConfig service '" + name + "' removed from JNDI");
        }
    }
    ...
    private void bind(String name, Object object) throws NamingException {
        ...
        log.info("BookmarkConfig Service bound to " + name);
    }
